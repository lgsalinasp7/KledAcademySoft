        ...
        <div className="max-w-5xl">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">
              ¡Hola, {studentData.name.split(' ')[0]} {studentData.name.split(' ')[1]}!
            </h1>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-400 mb-2">
                    <span>Completado: {studentData.overallProgress.toFixed(1)}%</span>
                  </div>
                  <ProgressBar 
                    percentage={studentData.overallProgress}
                    color="yellow"
                    height="sm"
                    showLabel={false}
                  />
