...
const videoRecordings: VideoRecording[] = [
  ...
  {
    id: '5',
    title: 'React Introduction Workshop',
    date: '04/08/2025',
    duration: '1:25:30',
    thumbnail: '/api/placeholder/320/180',
    module: 'Module 2',
...
export function VideoPlayer() {
  ...
  const filteredVideos = videoRecordings.filter(video => {
    ...
    return matchesSearch && (allowedTypes.length === 0 || (allowedTypes as string[]).includes(video.type));
  });
            ...
            <Card className="bg-gray-900 border-gray-700">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="text-white text-xl mb-2">{selectedVideo.title}</CardTitle>
